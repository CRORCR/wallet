...
var methods = function () {
    ...
    var generateOneTimeAddress = new Method({
        ...
        call: 'matrix_generateOneTimeAddress',
        params: 1,
        inputFormatter: [null]
    });
    ...
    var getSupportWanCoinOTABalances = new Method ({
        ...
        call: 'matrix_getSupportWanCoinOTABalances',
        params: 0,
    });

    var getSupportStampOTABalances = new Method ({
        name: 'getSupportStampOTABalances',
        call: 'matrix_getSupportStampOTABalances',
        params: 0,
    });
